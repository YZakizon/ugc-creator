          ...
          <DashboardTabs tabs={[
            { id: "overview", label: "Overview", content: <>
              ...
              <section className="hero-card" aria-labelledby="create-title">
                <div className="hero-copy"><span className="hero-kicker">CREATE SOMETHING NEW</span><h2 id="create-title">What do you want to talk about?</h2><p>Start with one topic, then generate and compare content versions until you are satisfied.</p><div className="hero-actions"><Link className="button button-light" href="#create">Create a topic <span>→</span></Link><Link className="text-link light-link" href="#content">View content history <span>↗</span></Link></div></div>
