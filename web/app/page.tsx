      ...
      <section className="content-area">
        ...
        <div className="page-content">
          ...
          <DashboardTabs tabs={[
            ...
            { id: "jobs", label: "Jobs", content: <section className="panel jobs-panel" aria-labelledby="jobs-title"><div className="panel-heading"><div><h2 id="jobs-title">Jobs</h2><p>Expand a job to inspect its details and generated results.</p></div></div><RecentJobs contentGenerationReady={openAiReady} speechGenerationReady={elevenLabsReady} detailed /></section> },
