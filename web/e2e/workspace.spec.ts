...
test.describe("workspace customer journeys", () => {
  ...
  test("creates a topic with repeatable numbered content, speech, video, and deletion", async ({ page }) => {
    ...
    await expect(firstJob.locator(".job-render-audio").getByText("burnout-is-not-laziness_content1_1-audio.wav")).toBeVisible();
    ...
    await expect(firstJob.locator(".job-render-audio").getByText("burnout-is-not-laziness_content1_2-audio.wav")).toBeVisible();
