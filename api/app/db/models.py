...
class VoicePreview(TimestampMixin, Base):
    ...
    generated_usage_units: Mapped[int | None] = mapped_column(nullable=True)
    account_used_units: Mapped[int | None] = mapped_column(nullable=True)
    account_limit_units: Mapped[int | None] = mapped_column(nullable=True)
    account_remaining_units: Mapped[int | None] = mapped_column(nullable=True)
    usage_resets_at_unix: Mapped[int | None] = mapped_column(nullable=True)
